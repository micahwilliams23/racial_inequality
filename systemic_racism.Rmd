...
prison.race %>%
  ...
  labs(title = 'Incarceration Rates by Race, 2008-2018',
       subtitle = 'While the difference in incarceration rates has narrowed in recent years, in 2018\nblack Americans were incarcerated at 5.7 times the rate of white Americans.', 
  ...
  scale_x_continuous(limits = c(2008,2018),
                     breaks = c(2008:2018),
                     labels = c('\'08', '\'09', 2010, paste('\'', c(11:18)))) +
...
prison.ribbon %>% mutate(rate.multiple = black / white)
```
