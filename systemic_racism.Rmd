...
lines <- tibble(x = c(106000,107000),
                y= c(97000, 130000),
                labels = c('\'Ideal\' Line', 'Line of Best Fit'),
                bold = c(1,2),
                angle = c(25,20))

# create plot ADD LABELS TO OUTLIER POINTS
income_plot <- county_income %>%
  ggplot() +
  ...
  labs(title = 'Median Household Income, Black vs. White by County',
       subtitle = 'Includes only counties with at least 5% black population.',
       x = 'Median Household Income, Black',
       y = 'Median Household Income, White',
       caption = 'Source: 2018 American Community Survey'); income_plot
